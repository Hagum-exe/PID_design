...
####MPU6050 data cleaning on flight
...
###safety checks and arm
            ...
            if rc_data[5] == 1000: # standby mode - switch in "up" or OFF position ##ARMS fc##
